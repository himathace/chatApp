    ...
    return(
        <div className="flex min-h-screen justify-center items-center bg-[#f5f5f5]">
            <div className=" w-fit rounded-xl p-7 bg-white shadow-xl">
                ...
                <div className="mb-6">
                    <TextField id="outlined-basic" label="Email" variant="outlined" sx={{width:'300px'}} inputProps={{sx:{height:17}}} />
                </div>
                <div className="mb-6">
                    <TextField id="outlined-basic" label="Password" variant="outlined" sx={{width:'300px'}}  inputProps={{sx:{height:17}}} />
                </div>
                <div className="mb-4">
                    <TextField id="outlined-basic" label="Confirm Password" variant="outlined" sx={{width:'300px'}} inputProps={{sx:{height:17}}} />
                </div>
                ...
                <div className="mb-4">
                    <Button variant="contained" sx={{width: '100%',height: '48px',backgroundColor: '#3b82f6',borderRadius: '0.5rem',color: '#fff',fontWeight: 500,fontSize: '1rem',textTransform: 'none','&:hover': {backgroundColor: '#2563eb',},}} >Create account</Button>
                </div>
                <div className="mb-4">
                    <Divider>or</Divider>
                </div>
                <div className="mb-6">
                    <button className="w-full flex justify-center items-center border h-12 rounded-lg gap-x-3">
