        ...
        <div className="flex min-h-screen justify-center items-center bg-[#f5f5f5]">
            <div className=" w-fit rounded-xl p-7 bg-white shadow-xl">
                ...
                <div className="mb-4">
                    ...
                    <Button variant="contained" sx={{width: '100%',height: '48px',backgroundColor: '#3b82f6',borderRadius: '0.5rem',color: '#fff',fontWeight: 500,fontSize: '1rem',textTransform: 'none','&:hover': {backgroundColor: '#2563eb',},}} >Sign in</Button>
                </div>
                <div className="mb-4">
                    <Divider>or</Divider>
                </div>
